 ...
 * @generated
 */
public class scairSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case scairPackage.FUNCTION: {
				Function function = (Function)theEObject;
				T result = caseFunction(function);
				if (result == null) result = caseIdentifiableElement(function);
				if (result == null) result = caseIIdentifiable(function);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case scairPackage.LABEL: {
				Label label = (Label)theEObject;
				T result = caseLabel(label);
				if (result == null) result = caseIdentifiableElement(label);
				if (result == null) result = caseIIdentifiable(label);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case scairPackage.CALL_GRAPH: {
				CallGraph callGraph = (CallGraph)theEObject;
				T result = caseCallGraph(callGraph);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case scairPackage.CONTAINER: {
				Container container = (Container)theEObject;
				T result = caseContainer(container);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case scairPackage.PROJECT: {
				Project project = (Project)theEObject;
				T result = caseProject(project);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case scairPackage.LABEL_ACCESS: {
				LabelAccess labelAccess = (LabelAccess)theEObject;
				T result = caseLabelAccess(labelAccess);
				if (result == null) result = caseStmtCall(labelAccess);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case scairPackage.TYPE_DEF: {
				TypeDef typeDef = (TypeDef)theEObject;
				T result = caseTypeDef(typeDef);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case scairPackage.TYPE_DEF_MEMBER: {
				TypeDefMember typeDefMember = (TypeDefMember)theEObject;
				T result = caseTypeDefMember(typeDefMember);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case scairPackage.STMT_CALL: {
				StmtCall stmtCall = (StmtCall)theEObject;
				T result = caseStmtCall(stmtCall);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case scairPackage.FUNCTION_CALL: {
				FunctionCall functionCall = (FunctionCall)theEObject;
				T result = caseFunctionCall(functionCall);
				if (result == null) result = caseStmtCall(functionCall);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case scairPackage.IIDENTIFIABLE: {
				IIdentifiable iIdentifiable = (IIdentifiable)theEObject;
				T result = caseIIdentifiable(iIdentifiable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case scairPackage.IDENTIFIABLE_ELEMENT: {
				...
				if (result == null) result = caseIIdentifiable(identifiableElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case scairPackage.MODE_ENTRY: {
				ModeEntry modeEntry = (ModeEntry)theEObject;
				T result = caseModeEntry(modeEntry);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case scairPackage.MODE_SWITCH: {
				ModeSwitch modeSwitch = (ModeSwitch)theEObject;
				T result = caseModeSwitch(modeSwitch);
				if (result == null) result = caseStmtCall(modeSwitch);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Type Def Member</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Type Def Member</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTypeDefMember(TypeDefMember object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Mode Entry</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Mode Entry</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseModeEntry(ModeEntry object) {
		return null;
	}
